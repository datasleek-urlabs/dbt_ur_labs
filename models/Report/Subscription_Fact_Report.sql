...
with Subscription_Fact_Report as (
    ...
    cte.Start_day_key,
    case when s.is_live = true then '9999-12-31' else cte.End_day_key end as End_day_key,
    ...
    case when s.is_live = true then 999999 else DATE_DIFF(cast(cte.End_day_key as DATE),cast(cte.Start_day_key as DATE),DAY) end as Days_Active
